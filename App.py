...
user = "sijan"  # MySQL user
password = "sijan123"  # MySQL user's password
...
def run():
    ...
    if choice == "Normal User":
        ...
        if st.button("Login"):
            if ad_user == "sandip" and ad_password == "sandip123":
                st.success("Welcome Sandip")
                # Display Data
